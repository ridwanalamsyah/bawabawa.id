...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Kami menerima QRIS, transfer Virtual Account (BCA, Mandiri, BNI, BRI), e-wallet (GoPay, OVO, ShopeePay, DANA), dan kartu kredit. Pembayaran diproses oleh Midtrans dan disimpan di escrow sampai barang diterima.",
  },
  {
