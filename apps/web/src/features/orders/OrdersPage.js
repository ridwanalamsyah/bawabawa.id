...
export function OrdersPage() {
    ...
    return (_jsx(EnterpriseModulePage, { title: "Orders Workflow", subtitle: `Alur transaksi order terkontrol dengan state machine enterprise. ${orderCount} order terdeteksi dari API.`, points: [
